...
app.get("/posts/:title" , function(req, res)
{
  ...
  titleValue = lodash.lowerCase(titleValue);

  posts.forEach(function(post)
  {
    let storedTitle = post.title;
    storedTitle = lodash.lowerCase(storedTitle);

    if (storedTitle === titleValue)
    {
      res.render("post" , {titlePost: post.title , bodyMessage: post.post});
    }
